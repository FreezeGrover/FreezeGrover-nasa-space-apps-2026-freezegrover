...
function EvidenceDetails({ result }: { result: unknown }) {
  ...
  return (
    <details className="evidence-details">
      <summary><span>◇</span> Show evidence analysis</summary>
